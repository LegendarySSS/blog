      ...
      <main>
        ...
        <section className=''>
          <div className='layout  pt-8'>
            <section className='grid grid-cols-[auto,334px] gap-8  mid:grid-cols-none midsm:block'>
              <article className='mdx prose dark:prose-invert mx-auto mt-4 w-full rounded-[8px] border border-white bg-white px-8 py-6 shadow transition-colors dark:border-gray-600 dark:bg-[#121212] mb:px-4'>
